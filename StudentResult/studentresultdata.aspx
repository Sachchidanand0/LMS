<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentresultdata.aspx.cs" Inherits="studentresultdata" %>
...
<body>
    <form id="form1" runat="server">
        <section class="container-fluid">
            <div class="row">
             <div class="col-md-2">
               <img src="Img/c-img4.png" class="img-fluid w-75" />
             </div>
                  <div class="col-md-8">
                      <h3 class="text-center">Welcome to DDU University</h3>
                  </div>
                  <div class="col-md-2">
                       <img src="Img/c-img4.png" class="img-fluid w-75" />
                  </div>
                        ...
                        <tr>
                            <td><h5>D.D.U University</h5></td>
                             ...
                             <td><span class="h5">Student ID:</span><span runat="server" class="h6" id="sid"></span></td>
                               ...
                               <tr>
                            <td><span class="h5">Student Name: </span><span runat="server" class="h6 text-danger" id="Stname"></span></td>
                              <td><span class="h5">Father Name: </span><span runat="server" class="h6 text-danger" id="Fname"></span></td>
                             <td><span class="h5">Gender: </span><span runat="server" class="h6 text-danger" id="gender">Male</span></td>
                             <td> <asp:Button runat="server" Text="Print" ID="prnt" class="btn btn-danger w-100" OnClick="prnt_Click"  /></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-1"></div>
